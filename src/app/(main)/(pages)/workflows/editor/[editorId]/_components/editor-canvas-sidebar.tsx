...
const EditorCanvasSidebar = ({nodes}: Props) => {
  ...
  return (
    <aside>
        <Tabs defaultValue="actions" className="h-screen overflow-screen pb-24">
            <TabsList className="bg-transparent">
                <TabsTrigger value="actions">Actions</TabsTrigger>
                <TabsTrigger value="settings">Settings</TabsTrigger>
            </TabsList> 
            <Separator />
            <TabsContent value="actions" className="flex flex-col gap-2 p-2 overflow-y-scroll">
            ...
            .map(([cardKey, cardValue]) => (
              ...
              >
                <CardHeader className="p-3">
                  ...
                  <CardDescription className='text-md'>{cardValue.description}</CardDescription>
                </CardHeader>
              </Card>
            ))}
        </TabsContent>
        <TabsContent
          ...
          className="-mt-6"
        >
          <div className="px-2 py-4 text-center text-lg font-bold">
